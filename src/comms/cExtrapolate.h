...
public:
	...
	float GetEndTime() const { return !(m_ExtrapolationType & ET_NOSTOP) && m_Duration > 0 ? m_StartTime + m_Duration : 0; }
...
// cExtrapolate<Type>::Clear
template<class Type>
inline void cExtrapolate<Type>::Clear() {
